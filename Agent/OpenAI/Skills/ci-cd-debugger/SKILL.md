...
<skill name="ci-cd-debugger" version="2.0.0">
  ...
  <spec_contract>
    <id>ci-cd-debugger</id>
    <name>ci-cd-debugger</name>
    <version>2.0.0</version>
    <last_updated>2026-02-09</last_updated>
    <purpose>Systematically diagnose and resolve CI/CD pipeline failures by identifying root causes from build logs.</purpose>
    <inputs>
